...
function cmb_sample_metaboxes( array $meta_boxes ) {
	...
	$groups_and_cols = array(
		...
		array( 'id' => 'gac-5', 'name' => 'Group (8 columns)', 'type' => 'group', 'cols' => 8, 'repeatable' => true, 'sortable' => true, 'fields' => array(
			array( 'id' => 'gac-5-f-1',  'name' => 'Text input field', 'type' => 'text' ),
			array( 'id' => 'gac-5-f-2',  'name' => 'Text input field', 'type' => 'text' ),
		) ),
		array( 'id' => 'gac-4', 'name' => 'Group (4 columns)', 'type' => 'group', 'cols' => 4, 'fields' => array(
			array( 'id' => 'gac-4-f-1',  'name' => 'Text field 1', 'type' => 'text' ),
			array( 'id' => 'gac-4-f-2',  'name' => 'Text field 2', 'type' => 'text' )
		) ),
	);
