...
class CMB_Select extends CMB_Field {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'select2', trailingslashit( CMB_URL ) . 'js/vendor/select2/select2.min.js', array( 'jquery' ), '4.0.3' );
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 'select2', trailingslashit( CMB_URL ) . 'js/vendor/select2/select2.min.css', array(), '4.0.3' );
	}
