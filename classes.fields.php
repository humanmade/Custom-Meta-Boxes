	...
	public function display() {
		...
		<div class="cmb-field-items">
			...
			if ( $this->args['repeatable'] ) :
				...
				<div class="cmb-field-item hidden" data-class="<?php echo esc_attr( get_class($this) ) ?>" style="position: relative">
				...
				<button class="button cmb-repeat-field"><?php esc_html_e( 'Add New', 'cmb' ); ?></button>
			...
			(function($) {
				...
				<?php if ( $this->args['ajax_url'] ) : ?>
					...
					var ajaxData = {
						...
						post_id : '<?php echo intval( 0 ); ?>', // Used for user capabilty check.
