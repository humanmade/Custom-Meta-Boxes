...
var CMB = {
	...
	repeatField : function( e ) {
		...
		templateField = field.find( '> .cmb-field-content > .cmb-field-item.hidden' );
		...
		field.find( '> .cmb-field-content > .cmb-field-item' ).not( templateField ).each( function() {
	...
	deleteField : function( e ) {
		...
		fieldItem = jQuery( this ).closest('.cmb-field-item' );
	...
	isMaxFields: function( field, modifier ) {
		...
		count  = field.find( '> .cmb-field-content > .cmb-field-item' ).not('.hidden').length + modifier; // Count after anticipated action (modifier)
		max    = field.attr( 'data-rep-max' );

		// Show all the remove field buttons.
		field.find( '> .cmb-field-content > .cmb-field-item > .cmb-delete-field, > > .cmb-field-content > .cmb-field-item > .group > .cmb-delete-field' ).show();
	...
	sortableInit : function( field ) {
		...
		var items = field.find( '> .cmb-field-content > .cmb-field-item' ).not('.hidden');

		field.find( '> .cmb-field-content > .cmb-field-item > .cmb-handle' ).remove();
		...
		field.sortable( {
			handle: "> .cmb-handle" ,
			cursor: "move",
			items: "> .cmb-field-content > .cmb-field-item",
